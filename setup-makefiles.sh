...
#mkdir -p ../../../vendor/motorola/motus/overlay/packages/apps/Launcher2/res/layout
#(cat << EOF) | sed s/__DEVICE__/$DEVICE/g > ../../../vendor/motorola/motus/overlay/packages/apps/Launcher2/res/layout/all_apps.xml
(cat << EOF) | sed s/__DEVICE__/$DEVICE/g > /dev/null
